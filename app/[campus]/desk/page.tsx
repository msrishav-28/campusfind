      ...
      <div className="mx-auto max-w-xl px-4 py-4 space-y-4">
        {!isAuthenticated ? (
          ...
          <div className="rounded-3xl border border-zinc-800 bg-zinc-900/70 p-6 text-center shadow-xl">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-500/10 text-2xl border border-amber-500/20">
              🛡️
            </div>
            <h2 className="mt-3 text-lg font-bold text-zinc-100">Campus Security Staff Portal</h2>
            <p className="mt-1 text-xs text-zinc-400">
              This section is reserved for campus security and facility staff at Block I to manage expired pins and turned-in physical belongings.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-2xl border border-zinc-800 bg-zinc-900/60 p-4">
              <div>
                ...
                <p className="mt-0.5 text-xs text-zinc-400">Block I Reception & Security Desk</p>
              </div>
                  ...
                  >
                    <div className="flex gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-zinc-400 truncate">📍 {item.placeLabel || "Campus spot"}</p>
                      </div>
                    </div>
